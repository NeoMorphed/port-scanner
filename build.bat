...
set executable="bin/debug/pscan"
set pdb="bin/debug"
...
set Libs= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib Ws2_32.lib iphlpapi.lib
...
:DEBUG
echo debug
cl %CompilerFlags% /Fo%obj% /Fe%executable% /Yupch.h /Fd%pdb% /I src %codePaths% /D __WINDOWS__ /D _CRT_SECURE_NO_WARNINGS /link /ignore:4099 /LIBPATH:dependencies/lib %Libs% bin-int/debug/pch.obj
GOTO END

:RELEASE
echo release
set obj="bin-int/release/"
set executable="bin/release/pscan"
set pdb="bin/release"
...
cl %CompilerFlags% /Fo%obj% /Fe%executable% /Yupch.h /I src %codePaths% /D __WINDOWS__ /D _CRT_SECURE_NO_WARNINGS /link /ignore:4099 /LIBPATH:dependencies/lib %Libs% bin-int/release/pch.obj
